<x-layouts.dashboard title="Saldo Nasabah">
    <div class="space-y-4">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('bank-sampah.savings.export') }}" class="bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-200 px-4 py-2 rounded-lg text-sm font-medium hover:bg-slate-200 dark:hover:bg-slate-700 transition">Export CSV</a>
        </div>
