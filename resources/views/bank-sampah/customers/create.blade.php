    ...
    <div class="max-w-2xl mx-auto space-y-6">
        <div class="flex items-center gap-4">
            ...
            <div>
                ...
                <p class="text-sm text-slate-500 dark:text-slate-400 mt-1">Tambahkan nasabah baru secara manual atau hubungkan warga existing</p>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-slate-900 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-800 p-6 transition-colors duration-300">
            <form method="POST" action="{{ route('bank-sampah.customers.store') }}" x-data="{ 
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <label class="relative flex flex-col p-4 rounded-xl border cursor-pointer focus:outline-none transition"
                                ...
                                <input type="radio" name="mode" value="manual" x-model="mode" @change="name = ''; phone = ''; address = ''; selectedMemberId = ''" class="sr-only">
                                <span class="text-sm font-bold text-slate-900 dark:text-slate-100 flex items-center gap-2">
                    ...
                    {{-- Hidden/Override parameters for Submission --}}
                    <div x-show="mode === 'existing'">
                        {{-- Keep hidden fields synced for backup when submitting existing warga mode --}}
