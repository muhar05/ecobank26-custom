<x-layouts.dashboard title="Import Harga Sampah">
    <x-form-card title="Import Harga Sampah" description="Upload file CSV untuk memperbarui harga nasabah dan harga agregator secara massal.">
        ...
        @if(session('import_result'))
            ...
            <div class="mx-6 sm:mx-8 mt-6 bg-emerald-50 dark:bg-emerald-900/20 border border-emerald-200 dark:border-emerald-800 rounded-xl p-5">
                <div class="flex items-start gap-4">
                    ...
                    <div class="w-full">
                        <h4 class="text-sm font-bold text-emerald-900 dark:text-emerald-100 mb-3">Import Berhasil</h4>
                        <div class="grid grid-cols-3 gap-4 mb-3">
                            ...
                            <div class="bg-white/60 dark:bg-black/20 rounded-lg p-3 text-center border border-rose-100 dark:border-rose-800/50">
                                ...
                                <p class="text-[10px] uppercase font-semibold text-rose-600 dark:text-rose-500">Error</p>
                            </div>
                        </div>
        ...
        <form method="POST" action="{{ route('bank-sampah.waste-prices.import.store') }}" enctype="multipart/form-data">
            ...
            <x-form-section title="1. Download Template" description="Gunakan template CSV ini agar format data sesuai dengan sistem.">
                <div class="flex items-center justify-between p-4 rounded-xl border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800/50">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <p class="text-sm font-semibold text-slate-900 dark:text-slate-100">template_harga_sampah.csv</p>
            ...
            <x-form-section title="Panduan Pengisian" description="Kolom yang dibutuhkan saat mengisi template CSV harga sampah.">
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div class="bg-slate-50 dark:bg-slate-800/50 rounded-xl p-4 border border-slate-100 dark:border-slate-800">
                        ...
                        <h4 class="text-sm font-semibold text-slate-900 dark:text-slate-100 mb-1">Satuan</h4>
                        <p class="text-xs text-slate-500 dark:text-slate-400">Kolom <code class="bg-slate-200 dark:bg-slate-700 px-1.5 py-0.5 rounded text-slate-700 dark:text-slate-300">unit</code> menentukan satuan berat atau volume (contoh: kg, liter).</p>
                    </div>
                    <div class="bg-slate-50 dark:bg-slate-800/50 rounded-xl p-4 border border-slate-100 dark:border-slate-800">
