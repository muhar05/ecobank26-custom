...
<head>
    <meta charset="UTF-8">
    <title>Laporan Kas Bank Sampah</title>
    <style>
...
<body onload="window.print()">
    ...
    <div class="header">
        ...
        <div class="title-section">
            <h1>Laporan Kas Bank Sampah</h1>
            <p style="margin: 2px 0;">RT/RW 026</p>
        </div>
    </div>

    <div class="summary-box">
        <p style="margin: 3px 0;">Periode: <strong>{{ $dateLabel }}</strong></p>
        ...
        <p style="margin: 3px 0; font-weight: bold;">Saldo Akhir: Rp {{ number_format($totalIn - $totalOut, 0, ',', '.') }}</p>
