<x-layouts.dashboard title="Pengeluaran Dana">
    <div class="space-y-6">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
                <h1 class="text-2xl font-bold text-slate-900 dark:text-white">Pengeluaran Dana</h1>
                <p class="mt-1 text-sm text-slate-600 dark:text-slate-400">Kelola dan pantau pengeluaran kas RT/RW</p>
            </div>
            <a href="{{ route('community-cash.expenses.create') }}" 
                ...
                <div class="flex-1">
                    <div class="relative">
                        ...
                        <input type="text" name="search" value="{{ $search ?? '' }}" 
                            placeholder="Cari kategori, keterangan, atau jumlah..." 
                            ...
                            <tr class="hover:bg-slate-50 dark:hover:bg-slate-700/50 transition-colors">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-center">
                                    <div class="flex items-center justify-center gap-2">
                                        <a href="{{ route('community-cash.expenses.edit', $e) }}" 
                                        ...
                                        <button type="button" 
                                            @click="$dispatch('open-delete-modal', {id: 'confirm-delete-modal', action: '{{ route('community-cash.expenses.destroy', $e) }}'})" 
                            ...
                            <tr>
                                <td colspan="6" class="px-6 py-12 text-center">
                                    <div class="flex flex-col items-center justify-center">
                                        ...
                                        <h3 class="text-sm font-medium text-slate-900 dark:text-slate-100 mb-1">Belum ada data pengeluaran</h3>
                                        <p class="text-sm text-slate-500 dark:text-slate-400">Mulai dengan mencatat pengeluaran pertama</p>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
